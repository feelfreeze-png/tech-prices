...
Дневные котировки (OHLCV) за 2 года по 19 монетам с Yahoo Finance (`<COIN>-USD`). Обновляются четыре раза в сутки: 00:41, 02:41, 08:41 и 17:41 UTC (GitHub может запускать с задержкой до нескольких часов).
